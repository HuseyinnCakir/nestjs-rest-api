...
import { GenerateTokensProvider } from 'src/auth/providers/generate-token.provider';
    ...
    async authenticate(googleTokenDto: GoogleTokenDto) {
      try {
        ...
        if (!email || !firstName || !lastName) {
          throw new UnauthorizedException('Missing required user information in Google token payload');
        }
